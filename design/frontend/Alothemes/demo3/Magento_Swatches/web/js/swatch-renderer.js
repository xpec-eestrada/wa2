...
define([
    ...
    $.widget('mage.SwatchRendererTooltip', {
        options: {
            ...
            tooltipClass: '888swatch-option-tooltip'  //configurable, but remember about css
        },
                ...
                if ($('.catalog-product-view').length) {
                    if ($('.swatch-attribute.size').length == 1) {
                        if ($('.swatch-attribute.size .swatch-attribute-options .swatch-option').length >= 1) {
                            if (!$('.swatch-attribute.size .swatch-attribute-options div.swatch-option:not(.disabled):first').hasClass('selected')) {
                    ...
                    if ($('.swatch-attribute.color').length == 1) {
                        if ($('.swatch-attribute.color .swatch-attribute-options .swatch-option').length >= 1) {
                            if (!$('.swatch-attribute.color .swatch-attribute-options div.swatch-option:not(.disabled):first').hasClass('selected')) {
